---
title: "Multi-class Classification Model on Antiretroviral Therapy Reaction and Failure Developed on the Unique Records of the Akwa Ibom HIV Database"
...
The brna and frna columns were multiplied by 10^2^ to simplify the unit from times 10^2^ copies to just copies. This aligns them with the unit used for RNA load in the WHO definition of HIV (World Health Organization, n.d.).
...
Its predicted drug reaction was obtained using the predict function. This was compared with the observed drug reaction in the test set utilizing the confusionMatrix function, which resulted in an accuracy of 88%. The accuracy came with good sensitivity and specificity for most outcome classes, but the model had a poor true positive detection rate for the class hi_tf.
...
The test accuracy of its outcome prediction was at 76.1%, lower than those from the preceding models. The accuracy was accompanied by good specificity, but the model had low to mediocre true positive detection rates for the classes vli, li and hi_tf.
...
The errors of the Rborist model were tabulated to additionally examine the possibility of the model being enhanced by ensembling it with the other models. However, this did not appear to be the best direction to take.
