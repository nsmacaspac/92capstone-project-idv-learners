...
The vhi_tf, hi_tf, li, vli, and ni columns were verified to have only one value per row. Hence, the binary system was relabeled as vhi_tf to ni and merged under a newly defined reaction column. This brought down the number of columns to eleven.
...
The sex and therapy variables were changed from character to numeric format using the case_when function. 
...
Given that all values were then in numeric format, the correlation of the variables was examined using the corrplot function (fig. 2; Wei and Simko 2021).
